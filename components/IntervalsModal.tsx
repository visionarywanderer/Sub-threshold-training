  ...
  return (
    <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center backdrop-blur-md p-4">
      <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md relative animate-in fade-in zoom-in duration-200">
        <button onClick={onClose} className="absolute top-4 right-4 text-slate-400 hover:text-slate-600 p-2 rounded-full hover:bg-slate-100">
          <X size={20} />
        </button>
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-slate-900">Connect Intervals.icu</h2>
        ...
        <div className="space-y-4">
            <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full pl-12 pr-4 py-4 bg-slate-50 border border-slate-100 rounded-xl font-mono text-sm focus:ring-2 focus:ring-norway-red/20 outline-none transition-all"
                  />
                </div>
            </div>
            ...
            <p className="text-[10px] text-center text-slate-400 px-6 mt-4">
