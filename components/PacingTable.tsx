...
import { calculatePaceForDistance, secondsToTime } from '../utils/calculations';
...
const PacingTable: React.FC<PacingTableProps> = ({ profile }) => {
  const races = [
    ...
    <div className="space-y-8">
        <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {races.map((race) => {
                    const pSec = calculatePaceForDistance(profile.raceDistance, profile.raceTime, race.dist);
