    ...
    <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center backdrop-blur-md p-4">
      <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md relative animate-in fade-in zoom-in duration-200">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-slate-900">Schedule Week on Intervals.icu</h2>
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-4 bg-slate-50 border border-slate-100 rounded-xl font-mono text-sm outline-none focus:ring-2 focus:ring-norway-red/20"
            />
          </div>
